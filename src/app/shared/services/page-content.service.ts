...
// import { MergedAbout } from '../interfaces/about.interface.js';
// import { MergedContent } from '../interfaces/merged-content.interface';
// import { MergedFeedbackContent } from '../interfaces/feedback.interface';
...
//   private addAboutToMerged(variable: VariableContent, statics: StaticContent): MergedContent {
//     return {
//       ...variable.about,
...
//         const match = statics.staticProjectInfos.find((s) => s.id === info.id);
//         if (!match) {
//           throw new Error(`Kein statisches Projet für id "${info.id}"`);
//         }
//         return { ...match, ...info };
//       }),
//     };
...
//   private addFeedbackToMerged(
//     variable: VariableContent,
//     statics: StaticContent,
//   ): MergedFeedbackContent {
//     return {
//       ...variable.feedback,
...
//         if (!match) {
//           throw new Error(`Kein statischer Feedback-Eintrag für id "${info.id}" gefunden.`);
//         }
...
import { StaticFooterInfos } from '../interfaces/footer.interface';
import { LanguageService } from './languageService';
import { MergedProjectContent } from '../interfaces/project.interface.js';
...
export class PageContentService {
  ...
  private addAboutToMerged(variable: VariableContent, statics: StaticContent): MergedAbout {
    return {
      ...variable.about,
      skills: statics.staticAboutInfos.skills,
    };
  }

  private addProjectsToMerged(variable: VariableContent, statics: StaticContent): MergedProjectContent {
    return {
      ...variable.projectInfos,
      projects: variable.projectInfos.projects.map((info) => {
  ...
  private addGeneralInfosToMerged(variable: VariableContent, statics: StaticContent): MergedGeneralInfos {
    return {
      ...variable.generalInfos,
      ...statics.staticGeneralInfos,
    };
